...
using Prueba_TredaSolution;
using Prueba_TredaSolution.Data;

namespace Prueba_TredaSolution.Controllers
{
    ...
    public class TiendasController : ControllerBase
    {
        ...
        public TiendasController(AplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Tienda>> PostTienda(Tienda tienda)
        {
          if (_context.Tiendas == null)
          {
              return Problem("Entity set 'AplicationDbContext.Tiendas'  is null.");
          }
        ...
        {
            return (_context.Tiendas?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
